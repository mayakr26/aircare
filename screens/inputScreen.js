    ...
    const addHandler = name => {
        if(name !== ''){
          ...
          setToDoData(toDoData => ({
            citiesair: [...toDoData.citiesair, new City(newIdCounterair+'', name, {summary: dataairaverage, 
              month: dataair}, "15.06,14.06,13.06,12.06,11.06,10.06,09.06")],
            citiestemp: [...toDoData.citiestemp, new City(newIdCountertemp+'', name, {summary: datatempaverage, 
              month: datatemp}, "15.06,14.06,13.06,12.06,11.06,10.06,09.06")]
          }));
        }
