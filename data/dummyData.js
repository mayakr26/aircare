...
export const CITIESAIR = [
  new City('1', 'Hamburg', 
  // Werte von 1981-2021 sind die richtigen Werte für Hamburg - keine weiteren gefunden - also die anderen ausgedacht
  {summary: [15,17,19,48,51,65.7,36], 
    month: [[10,15,16,48,48,53,35],
    [5,7,7,58,51,61,42],
    [10,10,12,54,59,66,39],
    [9,12,13,58,47,77,31],
    [10,15,16,49,58,77,32],
    [5,7,7,43,60,69,36],
    [8,8,9,37,53,66,35],
    [8,9,9,46,53,74,43],
    [10,12,13,49,42,73,49],
    [20,24,27,47,45,57,34],
    [35,36,39,48,45,56,34],
    [45,50,58,45,52,59,33]]} , Last7Days()),
  new City('2', 'Berlin', 
  // Werte von 1991-2021 sind richtig für Berlin - keine weiteren gefunden - also die anderen ausgedacht
  {summary: [57,63,65,71,171,144,82], 
    month: [[56,65,78,82,152,178,80],
    [65,69,67,76,130,171,118],
    [68,77,66,77,143,162,104],
    [49,56,51,55,160,110,57],
    [41,44,45,46,134,120,62],
    [42,48,51,58,155,87,70],
    [29,32,33,35,146,79,107],
    [36,48,51,57,156,117,69],
    [84,99,110,112,201,172,85],
    [81,83,87,89,227,170,91],
    [70,74,75,88,214,229,109],
    [67,72,76,79,152,134,116]]}, Last7Days()),
  new City('3', 'München', 
  // Werte für 2011 sind richtig für München - keine weiteren gefunden - also die anderen ausgedacht
  {summary: [67,72,78,82,95,77,71], 
    month: [[70,73,84,86,94,85,79],
    [70,74,82,87,96,86,70],
    [75,75,78,79,92,86,69],
    [69,72,79,89,102,90,82],
    [68,75,86,92,105,96,87],
    [69,79,81,85,98,85,63],
    [59,69,79,79,94,89,61],
    [65,72,79,82,99,91,85],
    [78,83,85,84,99,89,84],
    [65,67,71,72,89,77,62],
    [58,60,61,67,78,67,55],
    [59,65,71,78,96,82,65]]}, Last7Days()),
  new City('4', 'Frankfurt', 
  // Werte für 2001-2021 sind richtig für Frankfurt - keine weiteren gefunden - also die anderen ausgedacht
  {summary: [42,47,57,65,64,57,33], 
    month: [[56,65,78,82,72,60,44],
    [35,40,67,80,84,56,33],
    [43,54,66,70,66,62,31],
    [39,43,51,55,58,62,33],
    [39,44,45,58,60,62,30],
    [38,41,51,58,58,52,29],
    [30,32,47,57,60,45,27],
    [36,40,51,68,72,52,36],
    [39,42,46,49,52,61,41],
    [49,60,61,65,65,60,30],
    [50,51,59,67,68,66,35],
    [51,53,61,67,60,47,32]]}, Last7Days()),
  new City('5', 'Köln', 
    // keine richtigen Werte für Stickstoffdioxid gefunden für Köln - also alle ausgedacht
    {summary: [12,16,19,46,54,69,46], 
      month: [[11,12,16,49,50,55,39],
      [8,10,11,48,56,68,50],
      [10,11,13,54,59,66,49],
      [11,15,19,56,51,79,42],
      [10,15,17,52,67,82,52],
      [7,9,9,33,65,79,46],
      [8,8,9,37,57,74,46],
      [10,11,15,48,54,78,47],
      [9,11,12,46,44,75,49],
      [14,18,27,48,49,61,44],
      [27,36,39,47,46,60,45],
      [29,39,41,45,52,61,47]]}, Last7Days())
];
